        ...
        <section className="professional-section">
          <div className="bio-content">
            ...
            <div className="bio-text">
              ...
              <p>
                I worked at Nomic AI for the last year building AI systems that leverage vector embeddings and dimensionality reduction for retrieval, clustering, and analysis. I was responsible for the software and technical guides that enabled tens of thousands of developers to use Nomic models and products.
              </p>

              <p>
                Before that I worked for two years as a researcher at Arthur, an AI security and observability company, during the transition from classical ML to generative AI in enterprise deployments. I built interpretability systems for scalable model auditing, developed security systems to detect & mitigate against LLM failure modes like prompt injections and hallucinations, and had my work published at IEEE and ICLR.
              </p>

              <p>
                I received my MS in Data Science from Harvard University in 2020.
              </p>

              <p>Before studying and working in AI, I taught calculus and computer science at African Leadership Academy, a high school in Johannesburg, South Africa.</p>
              ...
              <div className="bio-content">
                <div className="nomic-images">
                  ...
                  <img src="/nomic/nomic-embed-v2-benchmark2.png" alt="Nomic Embed v2 Benchmark 2" />
              ...
              <h3>Pioneering Monitoring, Evaluation, & Security for the LLM Era</h3>
              <p>
