...
import UmapTutorial from './pages/cv/2024/UmapTutorial'
import NomicDocumentation from './pages/cv/2024/NomicDocumentation'
    ...
    <Router>
      <div className="app">
        ...
        <Routes>
          ...
          <Route path="/cv/2024/umap-tutorial" element={<UmapTutorial />} />
          <Route path="/cv/2024/nomic-documentation" element={<NomicDocumentation />} />
